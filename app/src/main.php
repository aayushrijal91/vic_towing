<header class="relative">
    ...
    <section class="banner py-9 md:py-24 lg:py-40">
        <div class="container">
            ...
            <h1 class="capitalize text-[60px] lg:text-8xl text-white font-articulat-heavy text-center leading-none"><span class="text-primary">24/7 Prompt Emergency</span> Towing for all makes and models</h1>
                    ...
                    <article class="min-h-[450px] md:min-h-[608px] h-full rounded-[20px] overflow-hidden relative">
                        ...
                        <div class="overlay absolute w-full bottom-0">
                            ...
                            <article class="bg-primary text-center p-5 lg:pb-12 text-white">
                                <h4 class="font-extrabold capitalize text-3xl lg:text-[40px] leading-none">24/7 prompt Emergency towing</h4>
                            </article>
                        </div>
                    </article>
                </div>
                <div class="w-full md:w-1/2 lg:w-1/3">
                    <article class="min-h-[450px] md:min-h-[608px] h-full rounded-[20px] overflow-hidden relative">
                        ...
                        <div class="overlay absolute w-full bottom-0">
                            <?= renderImg('slope.png', 'lib', 'w-full') ?>
                            <article class="bg-primary text-center p-5 lg:pb-12 text-white">
                                <h4 class="font-extrabold capitalize text-3xl lg:text-[40px] leading-none">60mins<br /> response time</h4>
                            </article>
                        </div>
                    </article>
                </div>
                <div class="w-full md:w-1/2 lg:w-1/3">
                    <article class="min-h-[450px] md:min-h-[608px] h-full rounded-[20px] overflow-hidden relative">
                        ...
                        <div class="overlay absolute w-full bottom-0">
                            <?= renderImg('slope.png', 'lib', 'w-full') ?>
                            <article class="bg-primary text-center p-5 lg:pb-12 text-white">
                                <h4 class="font-extrabold capitalize text-3xl lg:text-[40px] leading-none">No<br /> hidden costs</h4>
                            </article>
                        </div>
                    </article>
                </div>
...
<section class="services bg-dark rounded-t-[30px] pt-12 md:pt-16 lg:pt-24 pb-7">
    <div class="container">
        <h2 class="text-center text-[40px] md:text-[60px] lg:text-[80px] font-articulat-heavy leading-none text-white capitalize"><span class="text-primary">We are flexible, Affordable</span> And Cater to each Individual Client's Needs.</h2>
        ...
        <div class="flex flex-wrap lg:flex-nowrap lg:flex-row lg:space-x-3 gap-y-4 pt-20">
            <div class="w-full md:w-1/2 lg:w-1/4 md:px-1.5 lg:px-0">
...
<section class="bg-primary pb-5 lg:pb-0">
    <?= renderImg('anchor-dark.png', 'lib', 'w-full') ?>

    <div class="container pt-11 md:pt-16 lg:pt-20">
        <h2 class="text-center text-white font-articulat-heavy capitalize text-[40px] md:text-[60px] lg:text-[80px] leading-none">Tow Trucks <span class="text-dark">That Go The extra mile</span></h2>
...
<section class="bg-dark-grey py-14 md:py-24 rounded-[30px]">
    <div class="container">
        <div class="flex flex-wrap lg:flex-row lg:flex-nowrap justify-between items-center gap-y-4">
            <div class="w-full lg:w-7/12">
                <h3 class="text-white capitalize font-articulat-heavy text-[33px] md:text-[60px] lg:text-[80px] leading-none text-center lg:text-start"><span class="text-primary">Same Day</span> Emergency service</h3>
            </div>
            <div class="w-full lg:w-5/12">
                <p class="text-white text-sm md:text-2xl text-center lg:text-start">
                ...
                <div class="flex flex-row items-center justify-center lg:justify-start space-x-3 pt-7">
                    <div class="w-1/2 md:w-fit">
                        <a href="tel:<?= $phone_number ?>" class="bg-primary hover:bg-primary-dark duration-150 text-white text-sm md:text-xl font-semibold h-[60px] md:min-w-[216px] flex items-center justify-center gap-x-2 rounded-full p-3">
                            <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.7992 11.8498L10.1986 10.6175C9.92835 10.4886 9.62573 10.4588 9.33794 10.5327C9.05015 10.6065 8.7934 10.78 8.60775 11.0259L7.85829 12.0255C6.62958 11.1844 5.58363 10.0729 4.79057 8.76547L5.72764 7.96604C5.95798 7.76809 6.12045 7.49439 6.1897 7.18764C6.25896 6.88088 6.23111 6.55831 6.1105 6.2702L4.9619 3.48905C4.83305 3.17937 4.60525 2.92858 4.31914 2.78141C4.03304 2.63424 3.70722 2.60027 3.39981 2.68554L1.19832 3.29813C0.879291 3.3867 0.602062 3.59759 0.41965 3.89049C0.237237 4.18339 0.162442 4.53773 0.209567 4.88575C0.619809 7.92287 1.94114 10.7366 3.97579 12.9058C6.01044 15.075 8.64898 16.483 11.4965 16.919C11.8228 16.9683 12.1547 16.8876 12.4288 16.6922C12.7029 16.4969 12.8998 16.2007 12.982 15.8603L13.5563 13.512C13.6362 13.1842 13.6038 12.8367 13.465 12.532C13.3263 12.2274 13.0902 11.9855 12.7992 11.8498Z" fill="white" />
